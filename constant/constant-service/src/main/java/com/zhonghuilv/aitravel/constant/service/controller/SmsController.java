...
import com.chemin.smallserver.common.util.IpUtils;
import com.chemin.smallserver.constant.intf.Enum.EnumSmsTemplate;
import com.chemin.smallserver.constant.intf.Enum.EnumVcode;
import com.chemin.smallserver.constant.intf.clients.SmsClient;
import com.chemin.smallserver.constant.service.service.SmsService;
import com.chemin.smallserver.constant.service.util.CodeUtil;
...
public class SmsController implements SmsClient {
    ...
    public Boolean sendVerifyCode(@RequestParam("phone") String phone,
        ...
        smsService.sendMessage(phone, enumSmsTemplate.getCode(), "{\"code\":\"" + code + "\"}", enumSmsTemplate.getSign());
