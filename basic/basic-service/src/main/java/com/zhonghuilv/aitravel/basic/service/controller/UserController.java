...
import com.zhonghuilv.aitravel.basic.intf.enums.EnumState;
...
import com.zhonghuilv.aitravel.basic.intf.pojo.dto.WeixinUserInfoDTO;
import com.zhonghuilv.aitravel.basic.intf.pojo.vo.UserVO;
import com.zhonghuilv.aitravel.basic.service.mapper.RoleMapper;
import com.zhonghuilv.aitravel.basic.service.mapper.UserMapper;
import com.zhonghuilv.aitravel.basic.service.service.UserExtendsTableBandService;
import com.zhonghuilv.aitravel.basic.service.util.WechatCommonClient;
...
/**
 * Create By zhengjing on 2017/12/7 15:37
 */
@RestController
...
public class UserController extends BasicController<User> implements UserClient {
    ...
    public User save(@RequestBody User model) {
        ...
        //处理密码
        if (org.apache.commons.lang3.StringUtils.isNotBlank(model.getPassword())) {
...
//                userInfoDTO = wechatClient.code2UserInfo(loginVO.getCode());
        ...
        user.setState(EnumState.NORMAL.getState());
